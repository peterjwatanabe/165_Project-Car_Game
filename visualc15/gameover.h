...
class Game_Over {
	...
	float totalTime;
	int minutes, tenseconds, seconds, thousands, hundreds, tens, ones, finalScore;
...
public:
	...
	void displayStats(float elapsedTime, int score) {
	...
	void setupStats() {
		...
		mins = new TexRect(num, 0.55, -0.6, 0.1, 0.1);
